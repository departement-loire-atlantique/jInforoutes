...
<%--
  ...
  @Customizable: True
--%>
<%@page import="fr.cg44.plugin.infotraficplugin.selector.PastEventSelector"%>
...
<% 
// Evènements en cours
DataSelector eventSelector = new PastEventSelector();
request.setAttribute("plierPrincipal", false);
request.setAttribute("pastEvents", true);
%>
