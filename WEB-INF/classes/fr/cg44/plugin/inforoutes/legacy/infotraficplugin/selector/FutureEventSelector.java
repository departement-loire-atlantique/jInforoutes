...
/**
 * Title : FutureEventSelector.java<br />
 * Description : Sélectionne tous les évènements "prévisionnels"
 *
 * @author WYNIWYG Atlantique - v.chauvin
 * @version 1.0
 *
 */
public class FutureEventSelector implements DataSelector {

    /**
     * Constructor
     */
    public FutureEventSelector() {
        super();
    }
